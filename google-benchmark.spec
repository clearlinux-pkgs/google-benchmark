...
Source0  : https://github.com/google/benchmark/archive/v1.9.1/benchmark-1.9.1.tar.gz
...
%prep
%setup -q -n benchmark-1.9.1
cd %{_builddir}/benchmark-1.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733170301
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libbenchmark.so.1.9.1
/usr/lib64/libbenchmark_main.so.1
/usr/lib64/libbenchmark_main.so.1.9.1
