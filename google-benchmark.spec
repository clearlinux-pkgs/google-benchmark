...
Source0  : https://github.com/google/benchmark/archive/v1.9.3/benchmark-1.9.3.tar.gz
...
%prep
%setup -q -n benchmark-1.9.3
cd %{_builddir}/benchmark-1.9.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746627477
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libbenchmark.so.1.9.3
/usr/lib64/libbenchmark_main.so.1
/usr/lib64/libbenchmark_main.so.1.9.3
